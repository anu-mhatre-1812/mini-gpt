"""
Mini-GPT on Kaggle GPU — paste this whole file into ONE Kaggle notebook cell and run.

Setup BEFORE running (right panel):
  1. Settings -> Accelerator -> GPU T4 x2 (or T4)
  2. Settings -> Internet -> ON (requires phone verification on your Kaggle account)

Trains a 6-layer GPT on Marathi Wikipedia (char-level) in ~15-20 min on T4,
then generates sample text.
"""
